...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-c5i1vuw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-c5i1vuw.containers.anotherwebservice.com/
...
```
git clone git@github.com:destic-shadow/container-c5i1vuw.git
cd container-c5i1vuw
```
...
```
docker attach container-c5i1vuw
```
